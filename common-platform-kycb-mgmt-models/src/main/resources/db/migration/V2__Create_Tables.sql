...
CREATE TABLE IF NOT EXISTS verification_document (
                                                     ...
                                                     kyc_verification_id UUID REFERENCES kyc_verification(kyc_verification_id),
...
CREATE TABLE IF NOT EXISTS corporate_document (
                                                  corporate_document_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                  legal_person_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS power_of_attorney (
                                                 power_of_attorney_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                 corporate_document_id UUID REFERENCES corporate_document(corporate_document_id),
    legal_person_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS aml_screening (
                                             aml_screening_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                             party_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS aml_match (
                                         aml_match_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                         aml_screening_id UUID REFERENCES aml_screening(aml_screening_id),
    list_type list_type,
    list_source TEXT,
    matched_name TEXT,
    match_score NUMERIC,
...
CREATE TABLE IF NOT EXISTS corporate_structure (
                                                   corporate_structure_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                   legal_person_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS source_of_funds (
                                               source_of_funds_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                               party_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS compliance_case (
                                               compliance_case_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                               party_id UUID NOT NULL,
                                               case_type case_type,
...
CREATE TABLE IF NOT EXISTS compliance_action (
                                                 compliance_action_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                 compliance_case_id UUID REFERENCES compliance_case(compliance_case_id),
...
CREATE TABLE IF NOT EXISTS kyb_verification (
                                                kyb_verification_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                legal_person_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS economic_activity (
                                                 economic_activity_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                 legal_person_id UUID NOT NULL,
                                                 activity_code TEXT,
                                                 is_primary BOOLEAN,
                                                 sector_code TEXT,
...
CREATE TABLE IF NOT EXISTS expected_activity (
                                                 expected_activity_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                                 party_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS industry_risk (
                                             industry_risk_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
                                             activity_code TEXT,
                                             industry_name TEXT,
